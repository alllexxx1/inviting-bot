...
1️⃣ Расскажите в любой соцсети, что идёте на бесплатный мини-курс. Поделитесь, что ждёте от курса или почему решили присоединиться. В посте оставьте ссылку на этого бота: @MagicExpressBot, так большее количество людей сможет отправиться в путшествие и получить пользу. 
2️⃣ Пришлите скриншот вашего поста сюда.

💡 Пример текста:
«Я иду на бесплатный мини-курс «Магический экспресс»! 🚂 Это про нетворкинг, создание продуктов и продажи. Кто со мной? (ссылка на бота)».

Как только мы всё проверим, вы получите ваш билет! 🎟️
"""

SCREENSHOT_IS_BEING_PROCESSED_MESSAGE = """
Супер! Мы очень рады, что вы решили поучаствовать в нашем обучении! 🚀
Ваш скриншот сейчас на проверке. Пока не удаляйте размещённое сообщение – мы проверяем его наличие.
Как только всё будет подтверждено, вы получите свой билет на Магический экспресс и ссылку на закрытый канал. Ожидайте!
"""
